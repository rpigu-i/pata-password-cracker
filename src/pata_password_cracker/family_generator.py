...
class FamilyPasswordGenerator():
    ...
    def __init__(self, k, family_data):
        """
    ...
    def process_individual(self):
        ...
        for ind in self.family_data:
            for bio, values in ind.iteritems():
                ...
                pata_passwords.append(PasswordGenerator(self.cat, values).process_individual())
    ...
    def name_dob(self, bio, values):
        ...
        name_dob_combo = PasswordGenerator(self.cat, name_dob_combo).process_individual()
